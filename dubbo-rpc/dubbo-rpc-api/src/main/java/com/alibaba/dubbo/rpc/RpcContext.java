...
public class RpcContext {
    ...
    /**
     * 全局使用的变量，存放只供读取使用的内容
     * 目前只存继承WrappedChannelHandler的处理类，供监控线程池使用
     */
    private static ConcurrentMap<String, Object> readOnlyContext = new ConcurrentHashMap<String, Object>();

    public static ConcurrentMap<String, Object> getReadOnlyContext() {
