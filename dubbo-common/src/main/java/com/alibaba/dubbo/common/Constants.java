...
public class Constants {
    ...
    public static final String PROVIDER_THREAD_CHANNEL_HANDLER = "monitor.thread.provider"; // 服务端线程池所在handler，加到RpcContext中，供监控使用

    public static final String CONSUMER_THREAD_CHANNEL_HANDLER = "monitor.thread.consumer"; // 消费端线程池所在handler，加到RpcContext中，供监控使用
